...
resource "aws_api_gateway_method" "email_template_post" {
  rest_api_id   = aws_api_gateway_rest_api.api.id
...
resource "aws_api_gateway_integration" "email_template_post_integration" {
  rest_api_id             = aws_api_gateway_rest_api.api.id
  resource_id             = aws_api_gateway_resource.email_template_resource.id
  http_method             = aws_api_gateway_method.email_template_post.http_method
  integration_http_method = "POST"
  type                    = "AWS_PROXY"
...
resource "aws_api_gateway_deployment" "deployment" {
  depends_on = [
    ...
    aws_api_gateway_integration.email_template_post_integration,
